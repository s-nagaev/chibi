...
**Реселери моделей та агрегатори інференсу:**
- **Baseten**
- **Cheaper Inference**
...
- **Навички:** вбудовані навички постачаються всередині пакета й працюють одразу після встановлення; власні навички можна додати як `.md`-файли до `skills_dir` (файл з такою ж назвою перевизначає вбудований) — агент може завантажити їх до системного промпту за запитом (`load_skill`)
