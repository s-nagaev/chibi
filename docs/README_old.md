...
| `CONTEXT_SIZE_WARNING_THRESHOLD`| Context-usage percentage (of `MAX_HISTORY_TOKENS`) above which a context-overflow warning is injected into the system prompt. `0`–`100`.        | `50`                                                                                              |
