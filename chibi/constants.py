...
class UserContext(Enum):
    ...
    ACTIVE_IMAGE_TO_IMAGE_MODEL = "ACTIVE_IMAGE_TO_IMAGE_MODEL"
...
class UserAction(Enum):
    ...
    SELECT_IMAGE_TO_IMAGE_MODEL = "SELECT_IMAGE_TO_IMAGE_MODEL"
    SELECT_IMAGE_TO_IMAGE_MODEL_PROVIDER = "SELECT_IMAGE_TO_IMAGE_MODEL_PROVIDER"
    SELECT_PROVIDER = "SELECT_PROVIDER"
    SELECT_MODEL_PROVIDER = "SELECT_MODEL_PROVIDER"
    SET_API_KEY = "SET_API_KEY"
    IMAGINE = "IMAGINE"
    IMAGINE_FROM_IMAGE = "IMAGINE_FROM_IMAGE"
    NONE = None
